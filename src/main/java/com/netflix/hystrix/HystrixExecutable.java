...
public interface HystrixExecutable<R> extends HystrixInvokable<R>
{
     ...
     * @throws HystrixBadRequestException if the {@link HystrixCommand} instance considers request arguments to be invalid and needs to throw an error that does not represent a system failure
     */
    public R execute();
