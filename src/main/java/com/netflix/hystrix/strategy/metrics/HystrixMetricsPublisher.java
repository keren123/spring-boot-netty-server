...
public abstract class HystrixMetricsPublisher
{
     ...
     *
     * @param commandKey      {@link HystrixCommandKey} representing the name or type of {@link HystrixCommand}
     * @param commandGroupKey {@link HystrixCommandGroupKey} of {@link HystrixCommand}
     * @param metrics         {@link HystrixCommandMetrics} instance tracking metrics for {@link HystrixCommand} instances having the key as defined by {@link HystrixCommandKey}
     * @param circuitBreaker  {@link HystrixCircuitBreaker} instance for {@link HystrixCommand} instances having the key as defined by {@link HystrixCommandKey}
     * @param properties      {@link HystrixCommandProperties} instance for {@link HystrixCommand} instances having the key as defined by {@link HystrixCommandKey}
     ...
     *
     * @param threadPoolKey {@link HystrixThreadPoolKey} representing the name or type of {@link HystrixThreadPool}
     * @param metrics       {@link HystrixThreadPoolMetrics} instance tracking metrics for the {@link HystrixThreadPool} instance having the key as defined by {@link HystrixThreadPoolKey}
     * @param properties    {@link HystrixThreadPoolProperties} instance for the {@link HystrixThreadPool} instance having the key as defined by {@link HystrixThreadPoolKey}
     ...
     * @param metrics      {@link HystrixCollapserMetrics} instance tracking metrics for the {@link HystrixCollapser} instance having the key as defined by {@link HystrixCollapserKey}
     * @param properties   {@link HystrixCollapserProperties} instance for the {@link HystrixCollapser} instance having the key as defined by {@link HystrixCollapserKey}
