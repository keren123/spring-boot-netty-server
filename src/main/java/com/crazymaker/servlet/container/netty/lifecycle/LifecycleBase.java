...
package com.crazymaker.servlet.container.netty.lifecycle;

import com.crazymaker.servlet.container.netty.utils.ExceptionUtils;
...
public abstract class LifecycleBase implements Lifecycle
{
    ...
    public final synchronized void start() throws LifecycleException
    {
                ...
                LifecycleState.STARTED.equals(state))
        {
            ...
            {
                log.debug("lifecycleBase.alreadyStarted");
            }
    ...
    public final synchronized void stop() throws LifecycleException
    {
                ...
                LifecycleState.STOPPED.equals(state))
        {
            ...
            {
                Exception e = new LifecycleException();
                log.debug("lifecycleBase.alreadyStopped：" + e.toString());
            } else if (log.isInfoEnabled())
            {
        ...
        } catch (Throwable t)
        {
            ExceptionUtils.handleThrowable(t);
            setStateInternal(LifecycleState.FAILED, null, false);
            throw new LifecycleException("lifecycleBase.stopFail" + t.getMessage());
        } finally
        {
    ...
    public final synchronized void destroy() throws LifecycleException
    {
        if (LifecycleState.FAILED.equals(state))
        {
            ...
            } catch (LifecycleException e)
            {
                ...
                log.warn("lifecycleBase.destroyStopFail：" + e.toString());
            }
        }
                ...
                LifecycleState.DESTROYED.equals(state))
        {
            ...
            {
                Exception e = new LifecycleException();
                log.debug("lifecycleBase.alreadyDestroyed" + e.toString());
    ...
    {
        String msg = "lifecycleBase.invalidTransition:" +
