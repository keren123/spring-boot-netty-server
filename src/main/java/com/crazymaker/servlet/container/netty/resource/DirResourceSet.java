...
public class DirResourceSet extends AbstractFileResourceSet
{
    ...
    /**
     * Creates a new {@link WebResourceSet} based on a
     * directory.
     *
     * @param root         The {@link WebResourceRoot} this new
     *                     {@link WebResourceSet} will
     *                     be added to.
                          ...
                          String internalPath)
    {
        ...
        if (root.getContext().getAddWebinfClassesResources())
        {
            ...
            if (f.isDirectory())
            {
                root.createWebResourceSet(WebResourceRoot.ResourceSetType.RESOURCE_JAR, "/",
    ...
    protected void checkType(File file)
    {
        ...
        {
            throw new IllegalArgumentException(("dirResourceSet.notDirectory:" +
                    getInternalPath()));
        }
    }
    ...
    protected void initInternal() throws LifecycleException
    {
        ...
        if (getWebAppMount().equals(""))
        {
            ...
            if (mf != null && mf.isFile())
            {
                ...
                {
                    log.warn("dirResourceSet.manifestFail：" + mf.getAbsolutePath());
                }
            }
        }
    }
