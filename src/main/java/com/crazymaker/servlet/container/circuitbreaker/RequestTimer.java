...
public class RequestTimer
{
    ...
    private static RequestTimer INSTANCE = new RequestTimer();
     ...
     * <p>
     * NOTE: This will result in race conditions if {@link #addTimerListener(com.netflix.hystrix.util.RequestTimer.TimerListener)} is being concurrently called.
     * </p>
     */
     ...
     * <pre> {@code
     * // add a TimerListener
     * Reference<TimerListener> listener = RequestTimer.getInstance().addTimerListener(listenerImpl);
     *
    ...
    public Reference<TimerListener> addTimerListener(final TimerListener listener)
    {
        ...
        int interval = listener.getIntervalTimeInMilliseconds();
        Timeout f = executor.get().scheduleAtFixedRate(r, interval, interval, TimeUnit.MILLISECONDS);
...
//        ScheduledFuture<?> f = executor.get().getThreadPool().scheduleAtFixedRate(r, listener.getIntervalTimeInMilliseconds(), listener.getIntervalTimeInMilliseconds(), TimeUnit.MILLISECONDS);
    ...
    private static class TimerReference extends SoftReference<TimerListener>
    {
        ...
        TimerReference(TimerListener referent, Timeout f)
        {
            super(referent);
            this.f = f;
        }
    ...
    static class ScheduledExecutor
    {
        ...
        public void initialize()
        {
            ...
            ThreadFactory threadFactory = new ThreadFactory()
            {
                ...
                {
                    Thread thread = new Thread(r, "TimerPool-" + counter.incrementAndGet());
                    thread.setDaemon(true);
                    return thread;
                }

            };
            hashedWheelTimer = new HashedWheelTimer(threadFactory, 500, TimeUnit.MILLISECONDS, 256);
        ...
        public Timeout scheduleAtFixedRate(Runnable r, int interval, int interval1, TimeUnit timeUnit)
        {
