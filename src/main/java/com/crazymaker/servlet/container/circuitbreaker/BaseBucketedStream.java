...
public abstract class BaseBucketedStream<Event extends RequestEvent, Bucket, Output>
{
    ...
    protected BaseBucketedStream(final EventStream<Event> inputEventStream,
