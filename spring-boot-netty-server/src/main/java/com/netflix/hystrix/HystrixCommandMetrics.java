...
public class HystrixCommandMetrics extends HystrixMetrics
{
     ...
     *
     * @param key          {@link HystrixCommandKey} of {@link HystrixCommand} instance requesting the {@link HystrixCommandMetrics}
     * @param commandGroup Pass-thru to {@link HystrixCommandMetrics} instance on first time when constructed
     * @param properties   Pass-thru to {@link HystrixCommandMetrics} instance on first time when constructed
