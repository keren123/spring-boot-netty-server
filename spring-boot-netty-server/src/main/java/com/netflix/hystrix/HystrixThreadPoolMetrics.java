...
public class HystrixThreadPoolMetrics extends HystrixMetrics
{
     ...
     *
     * @param key        {@link HystrixThreadPoolKey} of {@link HystrixThreadPool} instance requesting the {@link HystrixThreadPoolMetrics}
     * @param threadPool Pass-thru of ThreadPoolExecutor to {@link HystrixThreadPoolMetrics} instance on first time when constructed
     * @param properties Pass-thru to {@link HystrixThreadPoolMetrics} instance on first time when constructed
