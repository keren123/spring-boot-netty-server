...
public abstract class HystrixEventNotifier
{
     ...
     * <b>Default Implementation: </b> Does nothing
     *
     * @param key                   {@link HystrixCommandKey} of command instance.
     * @param isolationStrategy     {@link ExecutionIsolationStrategy} the isolation strategy used by the command when executed
     * @param duration              time in milliseconds of executing <code>run()</code> method
     * @param eventsDuringExecution {@code List<HystrixEventType>} of events occurred during execution.
     */
