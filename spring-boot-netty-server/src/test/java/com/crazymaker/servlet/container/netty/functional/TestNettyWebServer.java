...
//        SpringApplication.run(TestNettyWebServer.class, args);
        ...
        ConfigurableApplicationContext applicationContext =   SpringApplication.run(TestNettyWebServer.class, args);
        ...
        System.out.println("\n----------------------------------------------------------\n\t" +
                ...
                "测试普通的字符串请求: \t\thttp://localhost:" + port + path+ "/string\n\t" +
                "测试性质的JSON请求: \t\thttp://localhost:" + port + path+ "/json?msg=sth\n\t" +
                "测试HTTP请求头和会话: \t\thttp://localhost:" + port + path+ "/echo?msg=sth\n\t" +
                "----------------------------------------------------------");
